...
#SBATCH --output=./checkpoints/1head-r8-alpha32b8SEED/log%j.out
#SBATCH --error=./checkpoints/1head-r8-alpha32b8SEED/log%j.err
...
deepspeed llava/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir ./checkpoints/1head-r${RANK}-alpha${ALPHA}-moe${NUM_EXPERTS} \
    --num_train_epochs 1 \
    ...
    --run_name "1head-r${RANK}-alpha${ALPHA}-moe${NUM_EXPERTS}"
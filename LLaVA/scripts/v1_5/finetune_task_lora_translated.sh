...
#SBATCH --job-name=mclMultilingual
#SBATCH -C h100
#SBATCH --nodes=1
...
#SBATCH --output=./checkpoints/2heads01-transGood2/log%j.out
#SBATCH --error=./checkpoints/2heads01-transGood2/log%j.err
...
deepspeed llava/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir ./checkpoints/2heads01Translated \
    --num_train_epochs 1 \
    ...
    --report_to wandb \
    --run_name "/checkpoints/2heads01Translated"

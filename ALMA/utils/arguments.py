# This file is adapted from the ALMA repository https://github.com/fe1ixxu/ALMA/blob/master/utils/arguments.py
# Under MIT License.
...
class ModelArguments:
    ...
    num_return_sequences: Optional[int] = field(
        default=1,
        metadata={
            "help": "Number of return sequences for generation"
        },
    )

    do_predict_all_beams: bool = field(
        default=False,
        metadata={
            "help": "Whether to predict all beams"
        },
    )

    do_compute_metrics: bool = field(
        default=False,
        metadata={
    ...
    is_mcl: bool = field(
        default=False,
        metadata={
            "help": "Whether to use MCL (Multi-Candidate Learning)"
        }
    )

    is_group_lora: bool = field(
        default=False,
        metadata={
            "help": "Whether to use group LoRA"
        }
    )
    ...
    num_hyps: int = field(
        default=1,
        metadata={
            "help": "Number of hypotheses for MCL"
        }
    )
    ...
    wta_training_mode: str = field(
        default="",
        metadata={
            "help": "Winner-takes-all training mode"
        }
    )
    ...
    wta_params_fin_temp: float = field(
        default=1e-6,
        metadata={
            "help": "WTA final temperature"
        }
    )

    wta_params_decay_rate: float = field(
        default=0.999,
        metadata={
            "help": "WTA decay rate"
        }

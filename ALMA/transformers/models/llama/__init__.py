...
try:
    ...
    _import_structure["modeling_llama_mh_lora"] = [
        "LlamaForCausalLM_MH_Lora",
        "LlamaModel",
        "LlamaPreTrainedModel",
        "LlamaForSequenceClassification",
        "LlamaForQuestionAnswering",
    ...
    _import_structure["modeling_llama_mh_group_lora"] = [
        "LlamaForCausalLM_MH_Group_Lora",
        "LlamaModel",
        "LlamaPreTrainedModel",
        "LlamaForSequenceClassification",
        "LlamaForQuestionAnswering",
...
if TYPE_CHECKING:
    ...
    try:
        ...
        from .modeling_llama_mh_lora import (
            LlamaForCausalLM_MH_Lora,
            LlamaForQuestionAnswering,
            LlamaForSequenceClassification,
            LlamaModel,
        ...
        from .modeling_llama_mh_group_lora import (
            LlamaForCausalLM_MH_Group_Lora,
            LlamaForQuestionAnswering,
            LlamaForSequenceClassification,
            LlamaModel,

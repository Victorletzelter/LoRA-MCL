...
from local_peft.utils.constants import DUMMY_MODEL_CONFIG
...
class PeftMixedModel(PushToHubMixin, torch.nn.Module):
    ...
    ```py
    >>> base_model = ...  # load the base model, e.g. from local_transformers
    ...
    def from_pretrained(
        ...
        **kwargs: Any,
        ...
        """
        # note: adapted from local_peftModel.from_pretrained
        ...
        # note: this is different from local_peftModel.from_pretrained
        ...
        # note: this is different from local_peftModel.from_pretrained, we always return a PeftMixedModel

...
from local_transformers.utils import cached_file
from local_transformers.utils.hub import get_checkpoint_shard_files
...
def replace_lora_weights_loftq(
    ...
    from local_peft.tuners.lora import Linear4bit

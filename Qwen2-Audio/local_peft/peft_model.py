...
from local_transformers import Cache, DynamicCache, EncoderDecoderCache, PreTrainedModel
from local_transformers.modeling_outputs import QuestionAnsweringModelOutput, SequenceClassifierOutput, TokenClassifierOutput
from local_transformers.utils import PushToHubMixin

from local_peft.utils.constants import DUMMY_MODEL_CONFIG, PEFT_TYPE_TO_PREFIX_MAPPING
...
class PeftModelForSequenceClassification(PeftModel):
    ...
    **Attributes**:
    ...
    Example:
        ...
        ```py
        >>> from local_transformers import AutoModelForSequenceClassification
        >>> from local_peft import PeftModelForSequenceClassification, get_peft_config
...
class PeftModelForCausalLM(PeftModel):
    ...
    Example:
        ...
        ```py
        >>> from local_transformers import AutoModelForCausalLM
        >>> from local_peft import PeftModelForCausalLM, get_peft_config
...
class PeftModelForSeq2SeqLM(PeftModel):
    ...
    Example:
        ...
        ```py
        >>> from local_transformers import AutoModelForSeq2SeqLM
        >>> from local_peft import PeftModelForSeq2SeqLM, get_peft_config
...
class PeftModelForTokenClassification(PeftModel):
    ...
    **Attributes**:
    ...
    Example:
        ...
        ```py
        >>> from local_transformers import AutoModelForSequenceClassification
        >>> from local_peft import PeftModelForTokenClassification, get_peft_config
...
class PeftModelForQuestionAnswering(PeftModel):
    ...
    **Attributes**:
    ...
    Example:
        ...
        ```py
        >>> from local_transformers import AutoModelForQuestionAnswering
        >>> from local_peft import PeftModelForQuestionAnswering, get_peft_config
...
class PeftModelForFeatureExtraction(PeftModel):
    ...
    **Attributes**:
    ...
    Example:
        ...
        ```py
        >>> from local_transformers import AutoModel
        >>> from local_peft import PeftModelForFeatureExtraction, get_peft_config

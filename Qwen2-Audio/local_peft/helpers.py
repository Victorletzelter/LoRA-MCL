...
def update_forward_signature(model: PeftModel) -> None:
    ...
    ```python
    >>> from local_transformers import WhisperForConditionalGeneration
    >>> from local_peft import get_peft_model, LoraConfig, update_forward_signature
...
def update_generate_signature(model: PeftModel) -> None:
    ...
    ```python
    >>> from local_transformers import AutoModelForSeq2SeqLM, AutoTokenizer
    >>> from local_peft import get_peft_model, LoraConfig, TaskType, update_generate_signature
...
def update_signature(model: PeftModel, method: str = "all") -> None:
    ...
    ```python
    >>> from local_transformers import AutoModelForSeq2SeqLM, AutoTokenizer
    >>> from local_peft import get_peft_model, LoraConfig, TaskType, update_signature

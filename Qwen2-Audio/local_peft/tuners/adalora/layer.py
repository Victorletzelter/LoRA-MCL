...
from local_peft.tuners.tuners_utils import check_adapters_to_merge
from local_peft.utils import transpose


if packaging.version.parse(transformers.__version__) >= packaging.version.parse("4.33.0"):
    from local_transformers.integrations import deepspeed_config
else:
    from local_transformers.deepspeed import deepspeed_config

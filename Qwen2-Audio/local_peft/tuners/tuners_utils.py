...
from local_transformers import PreTrainedModel
from local_transformers.pytorch_utils import Conv1D

from local_peft.utils import INCLUDE_LINEAR_LAYERS_SHORTHAND
from local_peft.utils.constants import (
    DUMMY_MODEL_CONFIG,
...
from local_peft.utils.peft_types import PeftType, TaskType
...
def _find_minimal_target_modules(
    ...
    Example:
        ```py
        >>> from local_peft.tuners.tuners_utils import _find_minimal_target_modules

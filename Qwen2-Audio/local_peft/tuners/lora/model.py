...
from local_peft.tuners.tuners_utils import (
    BaseTuner,
    BaseTunerLayer,
...
from local_peft.utils.merge_utils import dare_linear, dare_ties, magnitude_prune, task_arithmetic, ties
from local_peft.utils.other import get_pattern_key
...
from .layer import Conv2d, LoraLayer, dispatch_default, dispatch_group_lora
...
class LoraModel(BaseTuner):
    ...
    Example:
        ...
        >>> from local_peft import LoraModel, LoraConfig
        ...
        >>> import torch
        >>> import transformers
        >>> from local_peft import LoraConfig, PeftModel, get_peft_model, prepare_model_for_kbit_training
    ...
    **Attributes**:
    ...
    def _create_and_replace(
        ...
        from local_peft.tuners.adalora import AdaLoraLayer

...
from local_peft.tuners.lora.model import LoraModel
from local_peft.tuners.tuners_utils import BaseTuner
from local_peft.utils.constants import DUMMY_TARGET_MODULES
from local_peft.utils.save_and_load import set_peft_model_state_dict
...
def _load_adapter_into_lora_model(
    ...
    **kwargs,
    ...
    from local_peft.tuners.lora.config import LoraConfig
    from local_peft.utils.other import infer_device
    from local_peft.utils.save_and_load import load_peft_weights
...
class XLoraModel(BaseTuner):
    ...
    Example:
        ```py
        >>> from local_transformers import AutoModelForCausalLM, AutoConfig, BitsAndBytesConfig

...
native_group_lora_enabled=$GROUP_LORA_ENABLED
...
path_orig_weights_1_hyp="Qwen/Qwen2-Audio-7B-Instruct"
# $PROJECT_DIR/local_cache/models--Qwen--Qwen2-Audio-7B-Instruct/snapshots/0a095220c30b7b31434169c3086508ef3ea5bf0a

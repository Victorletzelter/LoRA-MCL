...
if is_accelerate_available():
    ...
    from monkey_patch_accelerate import patched_set_module_tensor_to_device as set_module_tensor_to_device
...
class PreTrainedModel(nn.Module, ModuleUtilsMixin, GenerationMixin, PushToHubMixin, PeftAdapterMixin):
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        ```python
        >>> from local_transformers import BertConfig, BertModel

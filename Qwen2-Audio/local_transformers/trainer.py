...
def _is_peft_model(model):
    if is_peft_available():
        ...
        #     from local_peft import PeftMixedModel
...
class Trainer:
    ...
    def _hp_search_setup(self, trial: Union["optuna.Trial", Dict[str, Any]]):
        ...
        if self.is_deepspeed_enabled:
            ...
            from local_transformers.integrations.deepspeed import HfTrainerDeepSpeedConfig
    ...
    def _fsdp_qlora_plugin_updates(self):
        if self.is_fsdp_enabled and _is_peft_model(self.model):
            from local_peft import LoraConfig
            from local_peft.utils.other import fsdp_auto_wrap_policy

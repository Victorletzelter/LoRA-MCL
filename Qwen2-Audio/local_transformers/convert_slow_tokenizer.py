...
def import_protobuf(error_message=""):
    ...
    if is_protobuf_available():
        ...
        if version.parse(google.protobuf.__version__) < version.parse("4.0.0"):
            from local_transformers.utils import sentencepiece_model_pb2
        else:
            from local_transformers.utils import sentencepiece_model_pb2_new as sentencepiece_model_pb2
        return sentencepiece_model_pb2
    else:

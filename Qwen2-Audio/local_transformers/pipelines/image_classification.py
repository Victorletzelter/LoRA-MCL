...
# Copied from local_transformers.pipelines.text_classification.sigmoid
def sigmoid(_outputs):
    return 1.0 / (1.0 + np.exp(-_outputs))


# Copied from local_transformers.pipelines.text_classification.softmax
...
# Copied from local_transformers.pipelines.text_classification.ClassificationFunction
...
class ImageClassificationPipeline(Pipeline):
    ...
    ```python
    >>> from local_transformers import pipeline

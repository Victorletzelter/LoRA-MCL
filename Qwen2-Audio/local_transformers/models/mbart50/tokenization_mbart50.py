...
class MBart50Tokenizer(PreTrainedTokenizer):
    ...
    ```python
    >>> from local_transformers import MBart50Tokenizer
    ...
    # Copied from local_transformers.models.albert.tokenization_albert.AlbertTokenizer.convert_tokens_to_string

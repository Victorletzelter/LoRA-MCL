...
# Copied from local_transformers.models.llava.modeling_llava.LlavaMultiModalProjector with Llava->VideoLlava
...
class VideoLlavaForConditionalGeneration(VideoLlavaPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        >>> from local_transformers import VideoLlavaProcessor, VideoLlavaForConditionalGeneration

...
class BeitForMaskedImageModeling(BeitPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from local_transformers import AutoImageProcessor, BeitForMaskedImageModeling
        >>> import torch
...
class BeitForSemanticSegmentation(BeitPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from local_transformers import AutoImageProcessor, BeitForSemanticSegmentation
        >>> from PIL import Image
        >>> import requests

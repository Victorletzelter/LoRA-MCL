...
# Copied from local_transformers.models.bert.modeling_bert.BertSelfAttention with Bert->XLMRobertaXL
...
# Copied from local_transformers.models.bert.modeling_bert.BertSdpaSelfAttention with Bert->XLMRobertaXL
...
# Copied from local_transformers.models.bert.modeling_bert.BertModel with Bert->XLMRobertaXL, BERT->XLM_ROBERTA_XL
...
class XLMRobertaXLForCausalLM(XLMRobertaXLPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```python
        >>> from local_transformers import AutoTokenizer, RobertaForCausalLM, RobertaConfig
        >>> import torch

...
class XLMRobertaXLConfig(PretrainedConfig):
    ...
    ```python
    >>> from local_transformers import XLMRobertaXLConfig, XLMRobertaXLModel
...
# Copied from local_transformers.models.roberta.configuration_roberta.RobertaOnnxConfig with Roberta->XLMRobertaXL

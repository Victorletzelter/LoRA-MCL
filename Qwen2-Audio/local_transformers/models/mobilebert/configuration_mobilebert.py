...
class MobileBertConfig(PretrainedConfig):
    ...
    ```python
    >>> from local_transformers import MobileBertConfig, MobileBertModel
...
# Copied from local_transformers.models.bert.configuration_bert.BertOnnxConfig with Bert->MobileBert

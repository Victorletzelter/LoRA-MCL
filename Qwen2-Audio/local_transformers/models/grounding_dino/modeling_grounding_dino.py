...
# Copied from local_transformers.models.deformable_detr.modeling_deformable_detr.MultiScaleDeformableAttentionFunction
...
# Copied from local_transformers.models.detr.modeling_detr.DetrFrozenBatchNorm2d with Detr->GroundingDino
...
# Copied from local_transformers.models.detr.modeling_detr.replace_batch_norm with Detr->GroundingDino
...
class GroundingDinoConvEncoder(nn.Module):
    ...
    # Copied from local_transformers.models.detr.modeling_detr.DetrConvEncoder.forward with Detr->GroundingDino
...
# Copied from local_transformers.models.detr.modeling_detr.DetrConvModel with Detr->GroundingDino
...
# Copied from local_transformers.models.deformable_detr.modeling_deformable_detr.DeformableDetrMultiscaleDeformableAttention with DeformableDetr->GroundingDino, Deformable DETR->Grounding DINO
...
# Copied from local_transformers.models.beit.modeling_beit.BeitDropPath with Beit->GroundingDino
...
# Copied from local_transformers.models.detr.modeling_detr.DetrMLPPredictionHead
...
class GroundingDinoForObjectDetection(GroundingDinoPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from local_transformers import AutoProcessor, GroundingDinoForObjectDetection
        >>> from PIL import Image
        >>> import requests

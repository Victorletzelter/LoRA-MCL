...
class Idefics3VisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from local_transformers.models.idefics3.modeling_idefics3 import Idefics3VisionTransformer
    >>> from local_transformers.models.idefics3.configuration_idefics3 import Idefics3VisionConfig
...
class Idefics3Config(PretrainedConfig):
    ...
    Example:
    ```python
    >>> from local_transformers import Idefics3Model, Idefics3Config

...
@dataclass
# Copied from local_transformers.models.encodec.modeling_encodec.EncodecDecoderOutput with Encodec->Dac, segment_length->input_length
...
class DacModel(DacPreTrainedModel):
    ...
    def forward(
        ...
        >>> from local_transformers import DacModel, AutoProcessor

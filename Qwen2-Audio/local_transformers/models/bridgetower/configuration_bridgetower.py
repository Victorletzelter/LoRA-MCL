...
class BridgeTowerVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from local_transformers import BridgeTowerVisionConfig
...
class BridgeTowerTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from local_transformers import BridgeTowerTextConfig
...
class BridgeTowerConfig(PretrainedConfig):
    ...
    ```python
    >>> from local_transformers import BridgeTowerModel, BridgeTowerConfig

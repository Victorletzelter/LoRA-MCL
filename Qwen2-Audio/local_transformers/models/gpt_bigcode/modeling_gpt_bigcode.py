    ...
    def forward(
        ...
        if not output_attentions and head_mask is None:
            ...
            logger.warning_once(
                ...
                ' Falling back to the manual attention implementation, but specifying the manual implementation will be required from local_transformers version v5.0.0 onwards. This warning can be removed using the argument `attn_implementation="eager"` when loading the model.'
            )
...
class GPTBigCodeMLP(nn.Module):
    ...
    # Copied from local_transformers.models.gpt2.modeling_gpt2.GPT2MLP.forward

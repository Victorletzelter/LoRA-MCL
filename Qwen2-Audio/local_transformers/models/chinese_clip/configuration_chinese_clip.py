...
class ChineseCLIPTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from local_transformers import ChineseCLIPTextConfig, ChineseCLIPTextModel
...
class ChineseCLIPVisionConfig(PretrainedConfig):
    ...
    Example:
    ```python
    >>> from local_transformers import ChineseCLIPVisionConfig, ChineseCLIPVisionModel
...
class ChineseCLIPConfig(PretrainedConfig):
    ...
    ```python
    >>> from local_transformers import ChineseCLIPConfig, ChineseCLIPModel

...
class TableTransformerConfig(PretrainedConfig):
    ...
    ```python
    >>> from local_transformers import TableTransformerModel, TableTransformerConfig
    ...
    # Copied from local_transformers.models.detr.configuration_detr.DetrConfig.__init__
    def __init__(
        self,
        use_timm_backbone=True,
...
# Copied from local_transformers.models.detr.configuration_detr.DetrOnnxConfig

...
class OneFormerImageProcessor(BaseImageProcessor):
    ...
    # Copied from local_transformers.models.maskformer.image_processing_maskformer.MaskFormerImageProcessor.post_process_semantic_segmentation
    ...
    # Copied from local_transformers.models.maskformer.image_processing_maskformer.MaskFormerImageProcessor.post_process_panoptic_segmentation

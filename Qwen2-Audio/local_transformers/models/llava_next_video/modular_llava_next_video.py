...
from local_transformers.models.llava_next.modeling_llava_next import (
...
class LlavaNextVideoConfig(PretrainedConfig):
    ...
    ```python
    >>> from local_transformers import LlavaNextVideoForConditionalGeneration, LlavaNextVideoConfig, CLIPVisionConfig, LlamaConfig
...
class LlavaNextVideoForConditionalGeneration(LlavaNextForConditionalGeneration):
    ...
    def forward(
        ...
        >>> import requests
        >>> import av
        >>> from local_transformers import AutoProcessor, LlavaNextVideoForConditionalGeneration

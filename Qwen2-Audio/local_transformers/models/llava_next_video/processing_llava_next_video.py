...
class LlavaNextVideoProcessor(ProcessorMixin):
    ...
    # Copied from local_transformers.models.llava_next.processing_llava_next.LlavaNextProcessor._get_number_of_features
    ...
    # Copied from local_transformers.models.llava_next.processing_llava_next.LlavaNextProcessor._get_unpadded_features

...
class CLIPFlashAttention2(CLIPAttention):
    ...
    # Adapted from local_transformers.models.llama.modeling_llama.LlamaFlashAttention2.forward
    def forward(
        self,
        hidden_states: torch.Tensor,
        attention_mask: Optional[torch.Tensor] = None,
    ...
    def forward(
        ...
        if output_attentions:
            ...
            logger.warning_once(
                ...
                "the manual implementation will be required from local_transformers version v5.0.0 onwards. This warning can "
...
class CLIPTextModel(CLIPPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from local_transformers import AutoTokenizer, CLIPTextModel
...
class CLIPVisionModel(CLIPPreTrainedModel):
    ...
    def forward(
        ...
        >>> import requests
        >>> from local_transformers import AutoProcessor, CLIPVisionModel
...
class CLIPModel(CLIPPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from local_transformers import AutoTokenizer, CLIPModel
    ...
    def get_image_features(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from local_transformers import AutoProcessor, CLIPModel
...
class CLIPTextModelWithProjection(CLIPPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from local_transformers import AutoTokenizer, CLIPTextModelWithProjection
...
class CLIPVisionModelWithProjection(CLIPPreTrainedModel):
    ...
    def forward(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from local_transformers import AutoProcessor, CLIPVisionModelWithProjection

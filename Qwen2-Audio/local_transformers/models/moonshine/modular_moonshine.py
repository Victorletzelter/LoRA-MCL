...
class MoonshineConfig(PretrainedConfig):
    ...
    ```python
    >>> from local_transformers import MoonshineModel, MoonshineConfig
...
class MoonshineModel(WhisperModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from local_transformers import AutoFeatureExtractor, MoonshineModel
...
class MoonshineForConditionalGeneration(MoonshinePreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from local_transformers import AutoProcessor, MoonshineForConditionalGeneration
        >>> from datasets import load_dataset

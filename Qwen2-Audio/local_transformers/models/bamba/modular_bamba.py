...
from local_transformers.models.jamba.modeling_jamba import JambaAttentionDecoderLayer
from local_transformers.models.llama.modeling_llama import (
    LlamaAttention,
    LlamaForCausalLM,
    LlamaMLP,
    LlamaRMSNorm,
...
from local_transformers.models.mamba2.modeling_mamba2 import (
    MambaRMSNormGated,
    pad_tensor_by_size,
    reshape_into_chunks,
    segment_sum,
...
# Adapted from local_transformers.models.jamba.modeling_jamba.HybridMambaAttentionDynamicCache for the v2 mixer
...
# Adapted from local_transformers.models.glm.modular_glm.apply_rotary_pos_emb
...
# Adapted from local_transformers.models.mamba2.modeling_mamba2.Mamba2Mixer
...
# Adapted from local_transformers.models.jamba.modeling_jamba.JambaModel
...
class BambaForCausalLM(LlamaForCausalLM):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from local_transformers import AutoTokenizer, BambaForCausalLM

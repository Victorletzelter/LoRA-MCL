...
# Copied from local_transformers.models.bert.modeling_bert.BertIntermediate with Bert->CPMAnt
...
# Copied from local_transformers.models.bert.modeling_bert.BertOutput with Bert->CPMAnt
...
class CpmAntForCausalLM(CpmAntPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from local_transformers import CPMAntTokenizer, CpmAntForCausalLM

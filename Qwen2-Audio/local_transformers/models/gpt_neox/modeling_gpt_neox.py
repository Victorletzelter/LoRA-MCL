...
# Copied from local_transformers.models.llama.modeling_llama.LlamaRotaryEmbedding with Llama->GPTNeoX
...
class GPTNeoXForCausalLM(GPTNeoXPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```python
        >>> from local_transformers import AutoTokenizer, GPTNeoXForCausalLM, GPTNeoXConfig
        >>> import torch

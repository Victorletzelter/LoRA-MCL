...
# Copied from local_transformers.models.bart.modeling_tf_bart.TFBartLearnedPositionalEmbedding with Bart->MBart
...
# Copied from local_transformers.models.bart.modeling_tf_bart.TFBartAttention with Bart->MBart
...
MBART_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> from local_transformers import AutoTokenizer, TFMBartForConditionalGeneration

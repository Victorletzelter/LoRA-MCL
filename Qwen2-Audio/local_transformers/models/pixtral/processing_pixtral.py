...
# Copied from local_transformers.models.pixtral.image_processing_pixtral.BatchMixFeature
...
class PixtralProcessor(ProcessorMixin):
    ...
    # Copied from local_transformers.models.clip.processing_clip.CLIPProcessor.batch_decode with CLIP->Llama
    ...
    # Copied from local_transformers.models.clip.processing_clip.CLIPProcessor.decode with CLIP->Llama
    ...
    @property
    # Copied from local_transformers.models.clip.processing_clip.CLIPProcessor.model_input_names

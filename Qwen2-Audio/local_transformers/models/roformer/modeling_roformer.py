...
# Copied from local_transformers.models.marian.modeling_marian.MarianSinusoidalPositionalEmbedding with Marian->RoFormer
...
# Copied from local_transformers.models.bert.modeling_bert.BertSelfOutput with Bert->RoFormer
...
# Copied from local_transformers.models.bert.modeling_bert.BertIntermediate with Bert->RoFormer
...
# Copied from local_transformers.models.bert.modeling_bert.BertOutput with Bert->RoFormer
...
# Copied from local_transformers.models.bert.modeling_bert.BertOnlyMLMHead with Bert->RoFormer
...
class RoFormerForCausalLM(RoFormerPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```python
        >>> from local_transformers import AutoTokenizer, RoFormerForCausalLM, RoFormerConfig
        >>> import torch

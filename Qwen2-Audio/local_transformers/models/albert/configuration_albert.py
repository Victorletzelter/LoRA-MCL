...
class AlbertConfig(PretrainedConfig):
    ...
    ```python
    >>> from local_transformers import AlbertConfig, AlbertModel
...
# Copied from local_transformers.models.bert.configuration_bert.BertOnnxConfig with Roberta->Albert

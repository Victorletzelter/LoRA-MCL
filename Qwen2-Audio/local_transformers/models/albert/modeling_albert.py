...
class AlbertAttention(nn.Module):
    ...
    # Copied from local_transformers.models.bert.modeling_bert.BertSelfAttention.transpose_for_scores
...
class AlbertForPreTraining(AlbertPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from local_transformers import AutoTokenizer, AlbertForPreTraining
        >>> import torch
...
class AlbertForMaskedLM(AlbertPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from local_transformers import AutoTokenizer, AlbertForMaskedLM

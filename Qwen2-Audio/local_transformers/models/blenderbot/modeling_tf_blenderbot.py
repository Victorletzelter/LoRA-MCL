...
# Copied from local_transformers.models.bart.modeling_tf_bart.TFBartAttention with Bart->Blenderbot
...
# Copied from local_transformers.models.mbart.modeling_tf_mbart.TFMBartEncoderLayer with MBart->Blenderbot
...
# Copied from local_transformers.models.mbart.modeling_tf_mbart.TFMBartDecoderLayer with MBart->Blenderbot
...
BLENDERBOT_GENERATION_EXAMPLE = r"""
    ...
    ```py
    >>> from local_transformers import AutoTokenizer, TFBlenderbotForConditionalGeneration

...
class ClvpEncoderConfig(PretrainedConfig):
    ...
    ```python
    >>> from local_transformers import ClvpEncoderConfig, ClvpEncoder
...
class ClvpDecoderConfig(PretrainedConfig):
    ...
    ```python
    >>> from local_transformers import ClvpDecoderConfig, ClvpDecoder
...
class ClvpConfig(PretrainedConfig):
    ...
    ```python
    >>> from local_transformers import ClvpConfig, ClvpModelForConditionalGeneration
    ...
    >>> from local_transformers import ClvpEncoderConfig, ClvpDecoderConfig

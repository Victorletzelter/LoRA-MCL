...
# Copied from local_transformers.models.llama.modeling_llama.LlamaRotaryEmbedding with Llama->Persimmon
...
# Copied from local_transformers.models.gpt_neox.modeling_gpt_neox.GPTNeoXMLP with GPTNeoX->Persimmon
...
class PersimmonForCausalLM(PersimmonPreTrainedModel, GenerationMixin):
    ...
    # Copied from local_transformers.models.llama.modeling_llama.LlamaForCausalLM.__init__ with LLAMA->PERSIMMON,Llama->Persimmon
    def __init__(self, config):
        super().__init__(config)
    ...
    def forward(
        ...
        ```python
        >>> from local_transformers import AutoTokenizer, PersimmonForCausalLM
...
# Copied from local_transformers.models.llama.modeling_llama.LlamaForSequenceClassification with LLAMA->PERSIMMON,Llama->Persimmon
...
# Copied from local_transformers.models.llama.modeling_llama.LlamaForTokenClassification with Llama->Persimmon, LLAMA->PERSIMMON

...
from local_transformers.models.superpoint.configuration_superpoint import SuperPointConfig
...
class SuperPointForKeypointDetection(SuperPointPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from local_transformers import AutoImageProcessor, SuperPointForKeypointDetection
        >>> import torch

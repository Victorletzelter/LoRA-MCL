...
class AlignTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from local_transformers import AlignTextConfig, AlignTextModel
...
class AlignVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from local_transformers import AlignVisionConfig, AlignVisionModel
...
class AlignConfig(PretrainedConfig):
    ...
    ```python
    >>> from local_transformers import AlignConfig, AlignModel
    ...
    >>> from local_transformers import AlignTextConfig, AlignVisionConfig

...
# Copied from local_transformers.models.llama.modeling_llama.LlamaRotaryEmbedding with Llama->Falcon
...
# Copied from local_transformers.models.bloom.modeling_bloom.dropout_add
...
class FalconAttention(nn.Module):
    ...
    # Copied from local_transformers.models.bloom.modeling_bloom.BloomAttention._merge_heads
...
class FalconPreTrainedModel(PreTrainedModel):
    ...
    # Adapted from local_transformers.modeling_utils.PreTrainedModel._check_and_enable_sdpa
    @classmethod

...
# Copied from local_transformers.models.bart.modeling_bart.BartLearnedPositionalEmbedding with Bart->TrOCR
...
# Copied from local_transformers.models.bart.modeling_bart.BartScaledWordEmbedding with Bart->TrOCR

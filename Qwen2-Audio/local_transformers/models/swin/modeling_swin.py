...
# Copied from local_transformers.models.beit.modeling_beit.BeitDropPath with Beit->Swin
...
class SwinForMaskedImageModeling(SwinPreTrainedModel):
    ...
    def forward(
        ...
        Examples:
        ```python
        >>> from local_transformers import AutoImageProcessor, SwinForMaskedImageModeling
        >>> import torch

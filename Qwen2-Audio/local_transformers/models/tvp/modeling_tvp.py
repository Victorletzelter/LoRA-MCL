...
# Copied from local_transformers.models.bert.modeling_bert.BertIntermediate with Bert->Tvp
...
# Copied from local_transformers.models.bert.modeling_bert.BertPooler with Bert->Tvp
...
class TvpModel(TvpPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from local_transformers import AutoConfig, AutoTokenizer, TvpModel
...
class TvpForVideoGrounding(TvpPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from local_transformers import AutoConfig, AutoTokenizer, TvpForVideoGrounding

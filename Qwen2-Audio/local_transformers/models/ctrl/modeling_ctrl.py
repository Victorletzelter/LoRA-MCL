...
class CTRLModel(CTRLPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from local_transformers import AutoTokenizer, CTRLModel
        >>> import torch
...
class CTRLLMHeadModel(CTRLPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from local_transformers import AutoTokenizer, CTRLLMHeadModel
...
class CTRLForSequenceClassification(CTRLPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from local_transformers import AutoTokenizer, CTRLForSequenceClassification

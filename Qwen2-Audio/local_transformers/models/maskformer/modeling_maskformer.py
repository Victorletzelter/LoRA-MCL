...
@dataclass
# Copied from local_transformers.models.detr.modeling_detr.DetrDecoderOutput
...
# Copied from local_transformers.models.detr.modeling_detr.DetrDecoderLayer
...
class MaskFormerModel(MaskFormerPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from local_transformers import AutoImageProcessor, MaskFormerModel
...
class MaskFormerForInstanceSegmentation(MaskFormerPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from local_transformers import AutoImageProcessor, MaskFormerForInstanceSegmentation
        >>> from PIL import Image
        >>> import requests

...
from local_transformers.models.maskformer.feature_extraction_maskformer import MaskFormerImageProcessor
from local_transformers.models.maskformer.modeling_maskformer import (
    MaskFormerConfig,

...
# Copied from local_transformers.models.convnext.modeling_convnext.drop_path
...
# Copied from local_transformers.models.beit.modeling_beit.BeitDropPath with Beit->Bit

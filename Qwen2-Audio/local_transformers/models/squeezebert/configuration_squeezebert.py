...
class SqueezeBertConfig(PretrainedConfig):
    ...
    ```python
    >>> from local_transformers import SqueezeBertConfig, SqueezeBertModel
...
# # Copied from local_transformers.models.bert.configuration_bert.BertOnxxConfig with Bert->SqueezeBert

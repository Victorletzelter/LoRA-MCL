...
from local_transformers import PretrainedConfig
from local_transformers.utils import logging
from local_transformers.utils.backbone_utils import BackboneConfigMixin, get_aligned_output_features_output_indices
...
class TextNetConfig(BackboneConfigMixin, PretrainedConfig):
    ...
    ```python
    >>> from local_transformers import TextNetConfig, TextNetBackbone

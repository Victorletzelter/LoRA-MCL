...
from local_transformers import PreTrainedModel, add_start_docstrings
from local_transformers.activations import ACT2CLS
...
from local_transformers.models.textnet.configuration_textnet import TextNetConfig
...
from local_transformers.utils.backbone_utils import BackboneMixin
...
class TextNetForImageClassification(TextNetPreTrainedModel):
    ...
    def forward(
        ...
        >>> import torch
        >>> import requests
        >>> from local_transformers import TextNetForImageClassification, TextNetImageProcessor

...
# Copied from local_transformers.models.resnet.modeling_resnet.ResNetConvLayer -> RTDetrResNetConvLayer
...
# Copied from local_transformers.models.resnet.modeling_resnet.ResNetShortCut -> RTDetrResNetChortCut
...
# Copied from local_transformers.models.resnet.modeling_resnet.ResNetEncoder with ResNet->RTDetrResNet
...
# Copied from local_transformers.models.resnet.modeling_resnet.ResNetPreTrainedModel with ResNet->RTDetrResNet
...
class RTDetrResNetBackbone(RTDetrResNetPreTrainedModel, BackboneMixin):
    ...
    def forward(
        ...
        ```python
        >>> from local_transformers import RTDetrResNetConfig, RTDetrResNetBackbone
        >>> import torch

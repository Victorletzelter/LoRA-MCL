...
# Copied from local_transformers.models.deformable_detr.modeling_deformable_detr.load_cuda_kernels
...
# Copied from local_transformers.models.conditional_detr.modeling_conditional_detr.inverse_sigmoid
...
# Copied from local_transformers.models.detr.modeling_detr.DetrFrozenBatchNorm2d with Detr->RTDetr
...
# Copied from local_transformers.models.detr.modeling_detr.replace_batch_norm with Detr->RTDetr
...
# Copied from local_transformers.models.deformable_detr.modeling_deformable_detr.DeformableDetrMultiscaleDeformableAttention with DeformableDetr->RTDetr
...
class RTDetrModel(RTDetrPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from local_transformers import AutoImageProcessor, RTDetrModel
...
class RTDetrForObjectDetection(RTDetrPreTrainedModel):
    ...
    def forward(
        ...
        **loss_kwargs,
        ...
        ```python
        >>> from local_transformers import RTDetrImageProcessor, RTDetrForObjectDetection
        >>> from PIL import Image
        >>> import requests
        >>> import torch

...
class BlipTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from local_transformers import BlipTextConfig, BlipTextModel
...
class BlipVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from local_transformers import BlipVisionConfig, BlipVisionModel
...
class BlipConfig(PretrainedConfig):
    ...
    ```python
    >>> from local_transformers import BlipConfig, BlipModel

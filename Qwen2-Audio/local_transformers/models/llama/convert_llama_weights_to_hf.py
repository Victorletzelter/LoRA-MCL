...
from local_transformers import GenerationConfig, LlamaConfig, LlamaForCausalLM, LlamaTokenizer, PreTrainedTokenizerFast
from local_transformers.convert_slow_tokenizer import TikTokenConverter


try:
    from local_transformers import LlamaTokenizerFast
...
```py
from local_transformers import LlamaForCausalLM, LlamaTokenizer
    ...
    def __init__(self, vocab_file, special_tokens=None, instruct=False, llama_version="3.2", **kwargs):
        ...
        if instruct or llama_version in ["Guard-3"]:
            ...
            if model_id is not None:
                from local_transformers import AutoTokenizer

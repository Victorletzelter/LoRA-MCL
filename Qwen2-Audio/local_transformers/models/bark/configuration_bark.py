...
@add_start_docstrings(
    ...
    ```python
    >>> from local_transformers import BarkSemanticConfig, BarkSemanticModel
...
@add_start_docstrings(
    ...
    ```python
    >>> from local_transformers import BarkCoarseConfig, BarkCoarseModel
...
@add_start_docstrings(
    ...
    ```python
    >>> from local_transformers import BarkFineConfig, BarkFineModel

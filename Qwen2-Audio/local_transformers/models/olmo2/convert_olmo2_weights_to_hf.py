...
from local_transformers import Olmo2Config, Olmo2ForCausalLM
from local_transformers.models.gpt2.tokenization_gpt2_fast import GPT2TokenizerFast
...
```py
from local_transformers import Olmo2ForCausalLM, AutoTokenizer

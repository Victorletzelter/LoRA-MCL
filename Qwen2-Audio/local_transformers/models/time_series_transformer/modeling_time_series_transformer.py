...
# Copied from local_transformers.models.marian.modeling_marian.MarianSinusoidalPositionalEmbedding with Marian->TimeSeries
...
# Copied from local_transformers.models.bart.modeling_bart.BartAttention with Bart->TimeSeriesTransformer
...
# Copied from local_transformers.models.bart.modeling_bart.BartEncoderLayer with Bart->TimeSeriesTransformer, BART->TIME_SERIES_TRANSFORMER
...
# Copied from local_transformers.models.bart.modeling_bart.BartDecoderLayer with Bart->TimeSeriesTransformer, with BART->TIME_SERIES_TRANSFORMER
...
class TimeSeriesTransformerModel(TimeSeriesTransformerPreTrainedModel):
    ...
    def forward(
        ...
        >>> import torch
        >>> from local_transformers import TimeSeriesTransformerModel
...
class TimeSeriesTransformerForPrediction(TimeSeriesTransformerPreTrainedModel):
    ...
    def forward(
        ...
        >>> from huggingface_hub import hf_hub_download
        >>> import torch
        >>> from local_transformers import TimeSeriesTransformerForPrediction

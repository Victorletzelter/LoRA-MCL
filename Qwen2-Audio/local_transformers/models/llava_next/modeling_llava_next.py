...
# Copied from local_transformers.models.llava.modeling_llava.LlavaMultiModalProjector with Llava->LlavaNext
...
# Copied from local_transformers.models.llava.modeling_llava.LlavaPreTrainedModel with Llava->LlavaNext,llava->llava_next
...
class LlavaNextForConditionalGeneration(LlavaNextPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        >>> import requests
        >>> from local_transformers import AutoProcessor, LlavaNextForConditionalGeneration

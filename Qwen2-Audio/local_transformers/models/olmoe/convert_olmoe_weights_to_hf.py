...
3. Load model via:
```
from local_transformers import OlmoeForCausalLM, AutoTokenizer
import torch
...
from local_transformers import OlmoeConfig, OlmoeForCausalLM
from local_transformers.models.gpt_neox.tokenization_gpt_neox_fast import GPTNeoXTokenizerFast

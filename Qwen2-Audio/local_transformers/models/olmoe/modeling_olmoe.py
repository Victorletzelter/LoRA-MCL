...
# Copied from local_transformers.models.llama.modeling_llama.LlamaRotaryEmbedding with Llama->Olmoe
...
# Copied from local_transformers.models.olmo.modeling_olmo.OlmoMLP with Olmo->Olmoe
...
# Copied from local_transformers.models.llama.modeling_llama.LlamaPreTrainedModel with Llama->Olmoe
...
# TODO: re-enable check: Copied from local_transformers.models.llama.modeling_llama.LlamaModel with Llama->Olmoe
...
class OlmoeForCausalLM(OlmoePreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **loss_kwargs,
        ...
        ```python
        >>> from local_transformers import AutoTokenizer, OlmoeForCausalLM

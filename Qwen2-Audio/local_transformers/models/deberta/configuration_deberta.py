...
class DebertaConfig(PretrainedConfig):
    ...
    ```python
    >>> from local_transformers import DebertaConfig, DebertaModel
...
# Copied from local_transformers.models.deberta_v2.configuration_deberta_v2.DebertaV2OnnxConfig

...
class SegformerImageProcessor(BaseImageProcessor):
    ...
    # Copied from local_transformers.models.vit.image_processing_vit.ViTImageProcessor.resize
    def resize(
        self,
        image: np.ndarray,
        size: Dict[str, int],
    ...
    # Copied from local_transformers.models.beit.image_processing_beit.BeitImageProcessor.reduce_label
    ...
    # Copied from local_transformers.models.beit.image_processing_beit.BeitImageProcessor.post_process_semantic_segmentation with Beit->Segformer

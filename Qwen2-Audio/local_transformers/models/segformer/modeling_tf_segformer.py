...
# Copied from local_transformers.models.convnext.modeling_tf_convnext.TFConvNextDropPath with ConvNext->Segformer
...
class TFSegformerForSemanticSegmentation(TFSegformerPreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> from local_transformers import AutoImageProcessor, TFSegformerForSemanticSegmentation

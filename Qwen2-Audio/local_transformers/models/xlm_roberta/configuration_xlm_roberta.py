...
class XLMRobertaConfig(PretrainedConfig):
    ...
    ```python
    >>> from local_transformers import XLMRobertaConfig, XLMRobertaModel
...
# Copied from local_transformers.models.roberta.configuration_roberta.RobertaOnnxConfig with Roberta->XLMRoberta

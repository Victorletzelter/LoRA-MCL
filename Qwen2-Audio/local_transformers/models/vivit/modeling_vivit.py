...
class VivitEmbeddings(nn.Module):
    ...
    # Adapted from local_transformers.models.vit.modeling_vit.ViTEmbeddings.interpolate_pos_encoding
...
# Copied from local_transformers.models.vit.modeling_vit.ViTSelfAttention with ViT->Vivit
...
# Adapted from local_transformers.models.vit.modeling_vit.ViTSdpaSelfAttention with ViT->Vivit
    ...
    def forward(
        ...
        if output_attentions or head_mask is not None:
            logger.warning_once(
                ...
                " the manual implementation will be required from local_transformers version v5.0.0 onwards. This warning can be"
...
# Copied from local_transformers.models.vit.modeling_vit.ViTSelfOutput with ViT->Vivit
...
# Copied from local_transformers.models.vit.modeling_vit.ViTAttention with ViT->Vivit
...
# Copied from local_transformers.models.vit.modeling_vit.ViTSdpaAttention with ViT->Vivit
...
class VivitModel(VivitPreTrainedModel):
    ...
    def forward(
        ...
        >>> from local_transformers import VivitImageProcessor, VivitModel
...
class VivitForVideoClassification(VivitPreTrainedModel):
    ...
    def forward(
        ...
        >>> from local_transformers import VivitImageProcessor, VivitForVideoClassification
        >>> from huggingface_hub import hf_hub_download

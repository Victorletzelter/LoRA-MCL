...
from local_transformers.utils import is_vision_available
from local_transformers.utils.generic import TensorType
...
class VivitImageProcessor(BaseImageProcessor):
    ...
    # Copied from local_transformers.models.efficientnet.image_processing_efficientnet.EfficientNetImageProcessor.rescale
    def rescale(
        self,
        image: np.ndarray,

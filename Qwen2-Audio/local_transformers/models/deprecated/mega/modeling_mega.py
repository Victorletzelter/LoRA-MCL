...
# copied from local_transformers.models.roberta.modeling_roberta.RobertaPooler with Roberta->Mega
...
class MegaForCausalLM(MegaPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from local_transformers import AutoTokenizer, MegaForCausalLM, AutoConfig
        >>> import torch
...
# copied from local_transformers.models.roberta.modeling_roberta.RobertaClassificationHead with Roberta->Mega

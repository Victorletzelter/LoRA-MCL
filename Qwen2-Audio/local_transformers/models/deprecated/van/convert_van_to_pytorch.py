...
from local_transformers import AutoImageProcessor, VanConfig, VanForImageClassification
from local_transformers.models.deprecated.van.modeling_van import VanLayerScaling

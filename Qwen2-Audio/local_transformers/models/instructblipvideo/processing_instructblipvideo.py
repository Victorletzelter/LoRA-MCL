...
class InstructBlipVideoProcessor(ProcessorMixin):
    ...
    # Copied from local_transformers.models.blip.processing_blip.BlipProcessor.batch_decode with BertTokenizerFast->PreTrainedTokenizer
    ...
    # Copied from local_transformers.models.blip.processing_blip.BlipProcessor.decode with BertTokenizerFast->PreTrainedTokenizer
    ...
    @property
    # Copied from local_transformers.models.blip.processing_blip.BlipProcessor.model_input_names

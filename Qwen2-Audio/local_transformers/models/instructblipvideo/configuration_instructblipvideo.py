...
class InstructBlipVideoVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from local_transformers import InstructBlipVideoVisionConfig, InstructBlipVideoVisionModel
...
class InstructBlipVideoQFormerConfig(PretrainedConfig):
    ...
    ```python
    >>> from local_transformers import InstructBlipVideoQFormerConfig, InstructBlipVideoQFormerModel

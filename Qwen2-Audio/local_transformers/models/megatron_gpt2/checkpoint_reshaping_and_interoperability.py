...
from local_transformers import AutoTokenizer, GPT2Config
from local_transformers.modeling_utils import WEIGHTS_INDEX_NAME, WEIGHTS_NAME
...
def merge_transformers_sharded_states(path, num_checkpoints):
    """
    Merge sharded checkpoints from local_transformers into a single checkpoint.

...
class AltCLIPTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from local_transformers import AltCLIPTextModel, AltCLIPTextConfig
...
class AltCLIPVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from local_transformers import AltCLIPVisionConfig, AltCLIPVisionModel
...
class AltCLIPConfig(PretrainedConfig):
    ...
    ```python
    >>> from local_transformers import AltCLIPConfig, AltCLIPModel

...
class XmodConfig(PretrainedConfig):
    ...
    ```python
    >>> from local_transformers import XmodConfig, XmodModel
...
# Copied from local_transformers.models.roberta.configuration_roberta.RobertaOnnxConfig with Roberta->Xmod

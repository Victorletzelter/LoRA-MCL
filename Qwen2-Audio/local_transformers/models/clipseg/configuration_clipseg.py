...
class CLIPSegTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from local_transformers import CLIPSegTextConfig, CLIPSegTextModel
...
class CLIPSegVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from local_transformers import CLIPSegVisionConfig, CLIPSegVisionModel
...
class CLIPSegConfig(PretrainedConfig):
    ...
    ```python
    >>> from local_transformers import CLIPSegConfig, CLIPSegModel

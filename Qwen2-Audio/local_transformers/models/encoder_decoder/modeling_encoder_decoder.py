...
class EncoderDecoderModel(PreTrainedModel, GenerationMixin):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        ```python
        >>> from local_transformers import EncoderDecoderModel
        ...
        if from_tf:
            from local_transformers import TFEncoderDecoderModel
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from local_transformers import EncoderDecoderModel, BertTokenizer
        >>> import torch

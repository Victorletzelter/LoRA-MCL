...
class FlaxEncoderDecoderModel(FlaxPreTrainedModel):
    ...
    def encode(
        ...
        ```python
        >>> from local_transformers import FlaxEncoderDecoderModel, BertTokenizer
    ...
    def __call__(
        ...
        ```python
        >>> from local_transformers import FlaxEncoderDecoderModel, BertTokenizer, GPT2Tokenizer
    ...
    def from_encoder_decoder_pretrained(
        ...
        **kwargs,
        ...
        ```python
        >>> from local_transformers import FlaxEncoderDecoderModel

...
# Copied from local_transformers.models.clip.modeling_clip.CLIPMLP with CLIP->MllamaVision
...
# Copied from local_transformers.models.llama.modeling_llama.LlamaRMSNorm with Llama->MllamaText
...
# Copied from local_transformers.models.gemma2.modeling_gemma2.Gemma2MLP with Gemma2->MllamaText
...
# Modified from local_transformers.models.llama.modeling_llama.LlamaDecoderLayer
...
class MllamaVisionModel(MllamaPreTrainedModel):
    ...
    def forward(
        ...
        >>> import requests
        >>> from local_transformers import AutoProcessor, MllamaVisionModel
...
class MllamaTextModel(MllamaPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from local_transformers import AutoProcessor, MllamaTextModel
...
class MllamaForCausalLM(MllamaPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **loss_kwargs,
        ...
        ```python
        >>> from local_transformers import AutoTokenizer, MllamaForCausalLM
...
class MllamaForConditionalGeneration(MllamaPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from local_transformers import AutoProcessor, MllamaForConditionalGeneration

...
class MllamaVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from local_transformers import MllamaVisionConfig, MllamaVisionModel
...
class MllamaTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from local_transformers import MllamaTextModel, MllamaTextConfig
...
class MllamaConfig(PretrainedConfig):
    ...
    ```python
    >>> from local_transformers import MllamaForConditionalGeneration, MllamaConfig, MllamaVisionConfig, MllamaTextConfig

...
# Copied from local_transformers.models.vit.modeling_vit.ViTPatchEmbeddings with ViT->ViTMSN
...
# Copied from local_transformers.models.vit.modeling_vit.ViTSelfAttention with ViT->ViTMSN
...
# Copied from local_transformers.models.vit.modeling_vit.ViTSdpaSelfAttention with ViT->ViTMSN
    ...
    def forward(
        ...
        if output_attentions or head_mask is not None:
            logger.warning_once(
                ...
                "specifying the manual implementation will be required from local_transformers version v5.0.0 onwards. "
...
# Copied from local_transformers.models.vit.modeling_vit.ViTSelfOutput with ViT->ViTMSN
...
# Copied from local_transformers.models.vit.modeling_vit.ViTAttention with ViT->ViTMSN
...
# Copied from local_transformers.models.vit.modeling_vit.ViTSdpaAttention with ViT->ViTMSN
...
# Copied from local_transformers.models.vit.modeling_vit.ViTIntermediate with ViT->ViTMSN
...
# Copied from local_transformers.models.vit.modeling_vit.ViTOutput with ViT->ViTMSN
...
# Copied from local_transformers.models.vit.modeling_vit.ViTLayer with ViT->ViTMSN, VIT->VITMSN
...
# Copied from local_transformers.models.vit.modeling_vit.ViTEncoder with ViT->ViTMSN
...
class ViTMSNModel(ViTMSNPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from local_transformers import AutoImageProcessor, ViTMSNModel
        >>> import torch
...
class ViTMSNForImageClassification(ViTMSNPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from local_transformers import AutoImageProcessor, ViTMSNForImageClassification
        >>> import torch
        >>> from PIL import Image
        >>> import requests

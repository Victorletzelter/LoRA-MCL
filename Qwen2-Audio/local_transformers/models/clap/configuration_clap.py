...
class ClapTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from local_transformers import ClapTextConfig, ClapTextModel
...
class ClapAudioConfig(PretrainedConfig):
    ...
    ```python
    >>> from local_transformers import ClapAudioConfig, ClapAudioModel
...
class ClapConfig(PretrainedConfig):
    ...
    ```python
    >>> from local_transformers import ClapConfig, ClapModel
    ...
    >>> from local_transformers import ClapTextConfig, ClapAudioConfig

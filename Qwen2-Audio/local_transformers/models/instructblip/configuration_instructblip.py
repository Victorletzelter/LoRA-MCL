...
class InstructBlipVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from local_transformers import InstructBlipVisionConfig, InstructBlipVisionModel
...
class InstructBlipQFormerConfig(PretrainedConfig):
    ...
    ```python
    >>> from local_transformers import InstructBlipQFormerConfig, InstructBlipQFormerModel

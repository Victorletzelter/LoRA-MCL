...
# Copied from local_transformers.models.beit.modeling_beit.BeitDropPath with Beit->Hiera
...
class HieraForPreTraining(HieraPreTrainedModel):
    ...
    def forward(
        ...
        Examples:
        ```python
        >>> from local_transformers import AutoImageProcessor, HieraForPreTraining
        >>> import torch

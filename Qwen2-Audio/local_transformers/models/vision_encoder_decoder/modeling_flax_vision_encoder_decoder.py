...
class FlaxVisionEncoderDecoderModel(FlaxPreTrainedModel):
    ...
    def encode(
        ...
        ```python
        >>> from local_transformers import AutoImageProcessor, FlaxVisionEncoderDecoderModel
    ...
    def __call__(
        ...
        ```python
        >>> from local_transformers import FlaxVisionEncoderDecoderModel, AutoImageProcessor, AutoTokenizer
        >>> from PIL import Image
        >>> import requests
    ...
    def from_encoder_decoder_pretrained(
        ...
        **kwargs,
        ...
        ```python
        >>> from local_transformers import FlaxVisionEncoderDecoderModel

...
from local_transformers import UdopConfig
from local_transformers.modeling_outputs import (
    Seq2SeqLMOutput,
    Seq2SeqModelOutput,
)
...
class UdopPreTrainedModel(PreTrainedModel):
    ...
    # Copied from local_transformers.models.prophetnet.modeling_prophetnet.ProphetNetPreTrainedModel._shift_right with ProphetNet->Udop
...
# Copied from local_transformers.models.t5.modeling_t5.T5LayerNorm with T5->Udop
...
# Copied from local_transformers.models.t5.modeling_t5.T5DenseActDense with T5->Udop
...
# Copied from local_transformers.models.t5.modeling_t5.T5DenseGatedActDense with T5->Udop
...
# Copied from local_transformers.models.t5.modeling_t5.T5LayerFF with T5->Udop
...
# Copied from local_transformers.models.t5.modeling_t5.T5Attention with T5->Udop
...
# Copied from local_transformers.models.t5.modeling_t5.T5LayerSelfAttention with T5->Udop
...
# Copied from local_transformers.models.t5.modeling_t5.T5LayerCrossAttention with T5->Udop
...
# Copied from local_transformers.models.t5.modeling_t5.T5Block with T5->Udop
...
class UdopModel(UdopPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from local_transformers import AutoProcessor, AutoModel
...
class UdopForConditionalGeneration(UdopPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```python
        >>> from local_transformers import AutoProcessor, UdopForConditionalGeneration
        >>> from datasets import load_dataset
...
class UdopEncoderModel(UdopPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from local_transformers import AutoProcessor, UdopEncoderModel

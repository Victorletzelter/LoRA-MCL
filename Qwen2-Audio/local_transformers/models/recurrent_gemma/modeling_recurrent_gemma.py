...
# Copied from local_transformers.models.gemma.modeling_gemma.GemmaRMSNorm with Gemma->RecurrentGemma
...
# TODO: re-enable check: Copied from local_transformers.models.llama.modeling_llama.LlamaForCausalLM with LLAMA->RECURRENTGEMMA,Llama->RecurrentGemma,llama->gemma
class RecurrentGemmaForCausalLM(RecurrentGemmaPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```python
        >>> from local_transformers import AutoTokenizer, RecurrentGemmaForCausalLM

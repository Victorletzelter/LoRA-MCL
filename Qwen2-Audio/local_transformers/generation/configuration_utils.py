...
class GenerationConfig(PushToHubMixin):
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        ```python
        >>> from local_transformers import GenerationConfig
...
class CompileConfig(object):
    ...
    Examples:
    ```python
    >>> from local_transformers import AutoModelForCausalLM, AutoTokenizer, CompileConfig

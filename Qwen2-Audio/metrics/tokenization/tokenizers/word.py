...
try:
    from tokenization.tokenizers.ptb import PTBWordTokenizer
except ImportError:
    PTBWordTokenizer = None
from tokenization.tokenizers.spacy import SpacyWordTokenizer
from tokenization.tokenizers.wrapper import TokenizerWrapper


class WordTokenizer(TokenizerWrapper):
    """Tokenizer facade class for the following word tokenizers classes:

    - :class:`~tokenization.tokenizers.ptb.PTBWordTokenizer`
    - :class:`~tokenization.tokenizers.spacy.SpacyWordTokenizer`

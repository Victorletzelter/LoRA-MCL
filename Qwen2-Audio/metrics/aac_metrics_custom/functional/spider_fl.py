...
def _spider_fl_from_outputs(
    ...
    spider_fl_outs_corpus = spider_outs_corpus.copy()  # Create a copy to avoid modifying the original
    spider_fl_outs_sents = spider_outs_sents.copy()    # Same for the sentences dictionary

    spider_fl_outs_corpus.update(fer_outs_corpus)
    spider_fl_outs_corpus.update({"spider_fl": spider_fl_score})

    spider_fl_outs_sents.update(fer_outs_sents)
    spider_fl_outs_sents.update({"spider_fl": spider_fl_scores})

...
from aac_metrics_custom.functional.fer import (
    fer,
    _load_echecker_and_tokenizer,
    BERTFlatClassifier,
    DEFAULT_FER_MODEL,
)
from aac_metrics_custom.functional.sbert_sim import (
    sbert_sim,
    _load_sbert,
...
def _fense_from_outputs(
    ...
    fense_outs_corpus = sbert_sim_outs_corpus.copy()  # Create a copy of the original dictionary
    fense_outs_corpus.update(fer_outs_corpus)
    fense_outs_corpus.update({"fense": fense_score})

    fense_outs_sents = sbert_sim_outs_sents.copy()  # Create a copy of the original dictionary
    fense_outs_sents.update(fer_outs_sents)
    fense_outs_sents.update({"fense": fense_scores})
